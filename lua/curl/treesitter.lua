...
M.add_treesitter_highlighting = function()
  ...
  for id, node in query:iter_captures(root, bufnr, 0, -1) do
    ...
    if name == "curl" then
      ...
      vim.hl.range(0, -1, "CurlCommandHighlight", {start_row, start_col}, {start_row, end_col}, {})
